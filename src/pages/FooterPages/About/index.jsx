    ...
    <div className="footer-page-container footer-page-para-color">
      ...
      <div className="footer-page-section">
        <div className="about-us">
          ...
          <p>
            Welcome to musique, an exciting platform that aims to reimagine and
            revolutionize the way we connect and share moments with others. A
            creative space where you can showcase your unique perspective,
        ...
        <div className="creators">
          ...
          <p>
            ...
            success. Together let's move ahead and make musique a huge success.
            Join us today on{" "}
            <a
