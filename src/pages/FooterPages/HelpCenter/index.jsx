...
const accordionData = [
  {
    key: 1,
    title: "What is musique ?",
    content:
      "musique is a social media platform that allows users to share photos, videos, and stories with their followers. ",
  },
  {
    key: 2,
  ...
  return (
    <>
      ...
      <section className="faq">
        <div>
          <h1 className="faqTitle">musique Frequently Asked Question</h1>
